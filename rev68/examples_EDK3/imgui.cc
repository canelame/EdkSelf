...
void prepare() {
  ...
  EDK3::CreateQuad(&geo, 40,20, true, true);
...
void IMGUI() {
  static char txt[1024] = "Esto es una prueba\0";
  static float clear_col[3] = {1,2,3};
  static char *str_bt1 = "BT1";
  ImGui::Begin("ESAT");
  ImGui::Text("Hello world %d", 123);
  if (ImGui::Button(str_bt1)) {
  ...
  ImGui::InputText("command", txt, 1024);
